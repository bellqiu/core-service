Ext.define('Ext.ux.multiupload.Upload', {
    ...
    height: 22,
    wmode: 'transparent',
    url: '/resources/ext/ux/multiupload/Upload.swf',
    statics: {
        instanceId: 0
    },
    constructor: function (config) {
        ...
        config.flashVars = Ext.apply({
            ...
            buttonImagePath: '/resources/ext/ux/multiupload/button.png',
            buttonImageHoverPath: '/resources/ext/ux/multiupload/button_hover.png',
