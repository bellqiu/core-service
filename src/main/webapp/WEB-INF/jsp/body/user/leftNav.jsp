...
<div class="list-group"> 
	 <a href="/ac/profile" id="profile" class="list-group-item ${empty page || page=='profile'?'active':''}">
	 	Main
	 </a>
	 <a href="/od/myOrder" id="myOrder" class="list-group-item ${(not empty page && page=='order')?'active':''}">My Order</a>
